...
namespace PlayFab
{
    ...
    public:
        ...
        static void GetAllActionGroups(ServerModels::GetAllActionGroupsRequest& request, ProcessApiCallback<ServerModels::GetAllActionGroupsResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
