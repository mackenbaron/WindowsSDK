...
namespace PlayFab
{
    ...
    public:
        ...
        static void ResetUsers(AdminModels::ResetUsersRequest& request, ProcessApiCallback<AdminModels::BlankResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void DeleteUsers(AdminModels::DeleteUsersRequest& request, ProcessApiCallback<AdminModels::DeleteUsersResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetAllActionGroups(AdminModels::GetAllActionGroupsRequest& request, ProcessApiCallback<AdminModels::GetAllActionGroupsResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
    ...
    private:
        ...
        static void OnResetUsersResult(CallRequestContainer& request);
        ...
        static void OnGetAllActionGroupsResult(CallRequestContainer& request);
