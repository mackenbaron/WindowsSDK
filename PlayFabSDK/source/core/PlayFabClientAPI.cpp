    ...
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnLoginWithTwitchResult, nullptr);
}
    ...
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnAddGenericIDResult, nullptr);
}
    ...
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnGetPlayFabIDsFromGenericIDsResult, nullptr);
}
    ...
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnGetPlayFabIDsFromTwitchIDsResult, nullptr);
}
    ...
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnLinkTwitchResult, nullptr);
}
    ...
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnRemoveGenericIDResult, nullptr);
}
    ...
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnUnlinkTwitchResult, nullptr);
}
