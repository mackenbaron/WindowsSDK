...
bool GameModeInfo::readFromValue(const rapidjson::Value& obj)
{
	...
	if (PerfCostPerGame_member != NULL) PerfCostPerGame = PerfCostPerGame_member->value.GetDouble();
...
void PlayFab::writeResultTableNodeTypeEnumJSON(ResultTableNodeType enumVal, PFStringJsonWriter& writer)
{
	switch(enumVal)
	{
...
ResultTableNodeType PlayFab::readResultTableNodeTypeFromValue(const rapidjson::Value& obj)
{
...
void PlayFab::writePlayerConnectionStateEnumJSON(PlayerConnectionState enumVal, PFStringJsonWriter& writer)
{
	switch(enumVal)
	{
...
PlayerConnectionState PlayFab::readPlayerConnectionStateFromValue(const rapidjson::Value& obj)
{
	std::string enumStr = obj.GetString();
